...
class SignUpForm(UserCreationForm):
    ...
    first_name = forms.CharField(help_text="<strong>Enter Your first name here</strong>", max_length=100, widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'First Name'}))
